    ...
    <div className="flex flex-col min-h-screen bg-[#050505] font-sans overflow-hidden text-white relative pt-32">
      ...
      <section className="relative px-6 pb-20 md:pb-32 max-w-6xl mx-auto text-center z-10">
        ...
        <p className="text-xl md:text-2xl text-gray-400 max-w-3xl mx-auto mb-12 font-medium leading-relaxed">
          EcoBite is a digital platform that connects restaurants with surplus
          food to NGOs and volunteers, helping reduce food waste and support
          people in need.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link
            to="/register"
            className="w-full sm:w-auto px-8 py-4 bg-white text-black rounded-full font-black text-lg hover:bg-gray-200 transition-all flex items-center justify-center gap-2 shadow-[0_0_30px_rgba(255,255,255,0.15)] hover:-translate-y-1"
          >
          ...
          <Link
            to="/about"
            className="w-full sm:w-auto px-8 py-4 bg-white/5 text-white border border-white/10 rounded-full font-bold text-lg hover:bg-white/10 transition-all flex items-center justify-center gap-2 hover:-translate-y-1"
          >
            Learn More
          </Link>
        </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              <div className="flex justify-center mb-3">
                <Utensils className="text-green-400" size={34} />
              </div>
            ...
            <div>
              <div className="flex justify-center mb-3">
                <Clock className="text-orange-400" size={34} />
              </div>
              <div className="text-lg font-black text-white mb-2">
                Expiry Tracking
              </div>
            ...
            <div>
              <div className="flex justify-center mb-3">
                <BarChart3 className="text-purple-400" size={34} />
              </div>
              <div className="text-lg font-black text-white mb-2">
                Impact Analytics
              </div>
      ...
      <section className="py-24 px-6 max-w-6xl mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400">
            Everyone has a role to play in reducing food waste.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="p-10 bg-white/5 backdrop-blur-xl rounded-[2.5rem] border border-white/10 hover:border-green-500/50 shadow-2xl transition-all group relative overflow-hidden hover:-translate-y-2">
            ...
            <h3 className="font-black text-2xl mb-4 text-white">
              For Restaurants
            </h3>

            <p className="text-gray-400 leading-relaxed mb-8">
              Add surplus food listings, set expiry time, upload food images,
              manage NGO requests, and track donation impact.
            </p>

            <Link
              to="/register"
              className="font-bold text-green-400 flex items-center gap-1 hover:gap-2 transition-all"
            >
          ...
          <div className="p-10 bg-white/5 backdrop-blur-xl rounded-[2.5rem] border border-white/10 hover:border-blue-500/50 shadow-2xl transition-all group relative overflow-hidden hover:-translate-y-2">
            ...
            <p className="text-gray-400 leading-relaxed mb-8">
              View nearby available food, request pickup, assign volunteers, and
              monitor meals received through your dashboard.
            </p>

            <Link
              to="/register"
              className="font-bold text-blue-400 flex items-center gap-1 hover:gap-2 transition-all"
            >
              Join as NGO <ArrowRight size={16} />
            </Link>
          </div>
          ...
          <div className="p-10 bg-white/5 backdrop-blur-xl rounded-[2.5rem] border border-white/10 hover:border-orange-500/50 shadow-2xl transition-all group relative overflow-hidden hover:-translate-y-2">
            ...
            <p className="text-gray-400 leading-relaxed mb-8">
              Accept assigned pickups, collect food from restaurants, and mark
              deliveries as picked up or delivered.
            </p>

            <Link
              to="/register"
              className="font-bold text-orange-400 flex items-center gap-1 hover:gap-2 transition-all"
            >
      ...
      <section className="py-24 relative z-10 bg-gradient-to-b from-transparent to-white/[0.02]">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400">
              A simple process from surplus food to successful delivery.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-12 relative">
            ...
            <div className="relative text-center">
              ...
              <p className="text-gray-400 text-sm">
                Restaurants post available edible surplus food with quantity,
                image, pickup address, and expiry time.
              </p>
            </div>
            ...
            <div className="relative text-center">
              ...
              <p className="text-gray-400 text-sm">
                NGOs request nearby food and assign a volunteer after the
                restaurant accepts the request.
              </p>
            </div>
            ...
            <div className="relative text-center">
              ...
              <p className="text-gray-400 text-sm">
                Volunteers collect the food and update pickup and delivery
                status in real time.
              </p>
            </div>
          </div>
      ...
      <section className="py-20 px-6 max-w-6xl mx-auto relative z-10">
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-[2.5rem] p-10 md:p-14 text-center shadow-2xl">
          ...
          <p className="text-gray-400 max-w-3xl mx-auto text-lg leading-relaxed">
            EcoBite includes user verification, expiry tracking, pickup status
            updates, and analytics dashboards so every donation can be managed
      ...
      <footer className="bg-white/5 backdrop-blur-md border-t border-white/10 pt-16 pb-8 px-6 mt-auto relative z-10">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="md:col-span-2">
            <Link
              to="/"
              className="flex items-center gap-2 text-white font-black text-2xl tracking-tight mb-4"
            >
              <Leaf className="text-green-500" strokeWidth={3} /> EcoBite
            </Link>

            <p className="text-gray-400 mb-6 max-w-sm">
              Building a sustainable future by ensuring edible surplus food
              reaches people instead of being wasted.
            </p>
          </div>
          ...
          <div>
            <h4 className="font-bold text-white mb-4">Our Modules</h4>
            <ul className="space-y-3 text-gray-400 text-sm">
              <li>Food Donation</li>
              <li>NGO Requests</li>
              <li>Volunteer Delivery</li>
        ...
        <div className="max-w-6xl mx-auto pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-4 text-gray-400">
            <div className="w-8 h-8 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-green-500/20 hover:text-green-400 hover:border-green-500/30 cursor-pointer transition-all shadow-md">
              𝕏
            </div>
            <div className="w-8 h-8 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-green-500/20 hover:text-green-400 hover:border-green-500/30 cursor-pointer transition-all shadow-md">
              in
